...
it('map([1, 2], (item) => item + 1) should be return [2, 3]', () => {
  expect(map([1, 2], (item) => item + 1)).to.be.deep.equal([2, 3])
})

it('map([1, 2], (item) => item + 2) should be return [3, 4]', () => {
  expect(map([1, 2], (item) => item + 2)).to.be.deep.equal([3, 4])
})
...
it('map([1, 2], (item, index, arr) => arr) should be return [[1, 2], [1, 2]]', () => {
...
it('map([1, 2]) should return [1, 2]', () => {
  expect(map([1, 2])).to.been.deep.equal([1, 2])
})