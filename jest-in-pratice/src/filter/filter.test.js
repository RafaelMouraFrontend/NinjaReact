...
it('filter to be should a function', () => {
  expect(filter).to.be.a('function')
})

it('filter([1, 2, 3], (item) => item) Should be return [1, 2, 3]', () => {
...
it('filter([1, 2, 3, 5, 1, 2], (item, index, array) => index === array.indexOf(item)) should be return [1, 2, 3, 5]', () => {
  expect(filter([1, 2, 3, 5, 1, 2], (item, index, array) => index === array.indexOf(item))).to.be.deep.equal([1, 2, 3, 5])
})